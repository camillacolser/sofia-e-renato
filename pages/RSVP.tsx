...
const RSVP: React.FC = () => {
  ...
  if (status === 'success') {
    return (
      <div className="text-center py-20 animate-in zoom-in duration-500">
        ...
        <p className="text-lg opacity-80">La tua partecipazione è stata registrata correttamente tramite Formspree.</p>
  ...
  return (
    <div className="max-w-md mx-auto animate-in fade-in duration-700">
      ...
      {status === 'error' && (
        <p className="mt-4 text-red-700 text-sm text-center">Si è verificato un errore durante l'invio. Assicurati che il modulo sia configurato correttamente su Formspree.</p>
      )}
    </div>
  );
};
